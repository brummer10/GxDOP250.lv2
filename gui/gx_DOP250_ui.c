...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    ui->vbox1 = gtk_vbox_new(TRUE, 35);

    gtk_box_pack_start(GTK_BOX(ui->pbox), ui->box, TRUE, TRUE, 4);
    gtk_box_pack_start(GTK_BOX(ui->box), ui->hbox, TRUE, TRUE, 4);
    gtk_box_pack_start(GTK_BOX(ui->box), ui->vbox, TRUE, TRUE, 80);
    gtk_box_pack_end(GTK_BOX(ui->pbox), ui->vbox1, FALSE, FALSE, 20);
    ...
    ui->label[1] = gtk_label_new("LEVEL");
    ...
    ui->args[1]->ui = ui;
    ui->args[1]->port_index = (int)LEVEL;
